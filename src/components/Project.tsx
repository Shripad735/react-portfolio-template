    ...
    <div className="projects-container" id="projects">
        ...
        <div className="projects-grid">
            <div className="project">
                <a href="https://traffic-buddy-frontend.vercel.app/" target="_blank" rel="noreferrer"><img {...imageProps} src={trafficBuddy} className="zoom" alt="thumbnail" width="100%"/></a>
            ...
            <div className="project">
                <a href="https://medium.com/@shripadkhandare/automate-your-mern-app-deployment-on-aws-with-cloudformation-a-ci-cd-pipeline-439eae6f8953" target="_blank" rel="noreferrer"><img {...imageProps} src={cicdPipeline} className="zoom" alt="thumbnail" width="100%"/></a>
            ...
            <div className="project">
                <a href="https://techathon-frontend-tau.vercel.app" target="_blank" rel="noreferrer"><img {...imageProps} src={shareplate} className="zoom" alt="thumbnail" width="100%"/></a>
            ...
            <div className="project">
                <a href="https://super-30-project-tracker-4kji.vercel.app" target="_blank" rel="noreferrer"><img {...imageProps} src={projectPlanner} className="zoom" alt="thumbnail" width="100%"/></a>
            ...
            <div className="project">                
                <a href="https://github.com/Shripad735/EMI-Calculator" target="_blank" rel="noreferrer"><img {...imageProps} src={emiCalculator} className="zoom" alt="thumbnail" width="100%"/></a>
            ...
            <div className="project">
                <a href="https://kiroween-api-zombie-1tj4.vercel.app/" target="_blank" rel="noreferrer"><img {...imageProps} src={apiZombie} className="zoom" alt="thumbnail" width="100%"/></a>
            ...
            <div className="project">
                <a href="https://github.com/Shripad735/Resume-Analyser-Python" target="_blank" rel="noreferrer"><img {...imageProps} src={resumeAnalyzer} className="zoom" alt="thumbnail" width="100%"/></a>
            ...
            <div className="project">
                <a href="https://github.com/Shripad735/Hospital-Management-System" target="_blank" rel="noreferrer"><img {...imageProps} src={hospitalmsystem} className="zoom" alt="thumbnail" width="100%"/></a>
            ...
            <div className="project">
                <a href="https://shopease-se-hackethon.streamlit.app" target="_blank" rel="noreferrer"><img {...imageProps} src={ShopEase} className="zoom" alt="thumbnail" width="100%"/></a>
            ...
            <div className="project">
                <a href="https://shripad735.github.io/comp-network/" target="_blank" rel="noreferrer"><img {...imageProps} src={NetworkVisualizer} className="zoom" alt="thumbnail" width="100%"/></a>
