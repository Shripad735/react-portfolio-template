      ...
      <div className="projects-grid">
        <div className="project">
          ...
          <a
            ...
            rel="noreferrer"
          >
            <h2>Traffic Buddy PC-City</h2>
          </a>
          <p>
            Built a WhatsApp-based reporting system for traffic issues for PCMC
        ...
        <div className="project">
          <a
            href="https://shripad735.github.io/streamfetch/"
            target="_blank"
            rel="noreferrer"
          >
            <img
          ...
          <a
            ...
            rel="noreferrer"
          >
            <h2>StreamFetch - Advanced Desktop Media Downloader</h2>
          </a>
          <p>
            Built a secure Electron desktop app with a modern React + Tailwind
            UI for downloading media using yt-dlp and ffmpeg. Implemented
            IPC-safe architecture, robust background queue/process handling,
            cookie-based auth recovery for restricted content, and automated
            Windows release delivery through GitHub Actions.
            <strong>
              Codebase Link{" "}
              <a
                href="https://github.com/Shripad735/streamfetch"
                target="_blank"
                rel="noreferrer"
              >
                here
        ...
        <div className="project">
          <a
            href="https://shripad735.github.io/ClipStack/"
            target="_blank"
            rel="noreferrer"
          >
            <img
          ...
          <p>
            Built ClipStack, a lightweight and local-first clipboard manager for
            Windows using Tauri (Rust) and React + Vite. The application
            provides persistent clipboard history with fast fuzzy search, pinned
            items, reusable snippets, and keyboard-first workflows through a
            global overlay shortcut. Implemented local SQLite-based storage to
            ensure all clipboard data remains on-device with no cloud
            dependency.{" "}
            <strong>
              Codebase Link{" "}
              <a
                href="https://github.com/Shripad735/ClipStack"
                target="_blank"
                rel="noreferrer"
              >
                here
        ...
        <div className="project">
          <a
            href="https://medium.com/@shripadkhandare/automate-your-mern-app-deployment-on-aws-with-cloudformation-a-ci-cd-pipeline-439eae6f8953"
            target="_blank"
            rel="noreferrer"
          >
            <img
        ...
        <div className="project">
          <a
            href="https://techathon-frontend-tau.vercel.app"
            target="_blank"
            rel="noreferrer"
          >
            <img
          ...
          <a
            ...
            rel="noreferrer"
          >
            <h2>SharePlate - Food Waste Reduction</h2>
          </a>
          <p>
            A platform connecting restaurants with surplus food to NGOs to
            reduce waste. Built with MERN stack, it features real-time listings,
            location-based search, and JWT auth.{" "}
            <strong>
              Codebase Link{" "}
              <a
                href="https://github.com/Shripad735/SharePlateTSX"
                target="_blank"
                rel="noreferrer"
              >
                here
        ...
        <div className="project">
          <a
            href="https://github.com/Shripad735/Hospital-Management-System"
            target="_blank"
            rel="noreferrer"
          >
            <img
          ...
          <p>
            A Hospital Management System using Java, Servlets, and MySQL.
            Features patient records, appointments, billing, and user auth.
        ...
        <div className="project">
          <a
            href="https://super-30-project-tracker-4kji.vercel.app"
            target="_blank"
            rel="noreferrer"
          >
            <img
        ...
        <div className="project">
          <a
            href="https://github.com/Shripad735/EMI-Calculator"
            target="_blank"
            rel="noreferrer"
          >
            <img
          ...
          <p>
            A comprehensive full-stack mobile app featuring seven essential
            financial tools including EMI, SIP, PPF, and GST calculators
        ...
        <div className="project">
          <a
            href="https://kiroween-api-zombie-1tj4.vercel.app/"
            target="_blank"
            rel="noreferrer"
          >
            <img
          ...
          <a
            ...
            rel="noreferrer"
          >
            <h2>APIZombie - AI-Powered API Testing</h2>
          </a>
          <p>
            An all-in-one testing platform unifying REST, GraphQL, and gRPC
            protocols. Features Groq AI for generating requests from plain
            English, visual workflow builder, and comprehensive analytics.{" "}
            <strong>
              Codebase Link{" "}
              <a
                href="https://github.com/Shripad735/Kiroween-APIZombie"
                target="_blank"
                rel="noreferrer"
              >
                here
        ...
        <div className="project">
          <a
            href="https://github.com/Shripad735/Resume-Analyser-Python"
            target="_blank"
            rel="noreferrer"
          >
            <img
          ...
          <a
            ...
            rel="noreferrer"
          >
            <h2>Resume Analyzer - Python</h2>
          </a>
          <p>
            Built a resume analyzer using Python, NLTK, and Streamlit. It uses
            NLP for skill assessment, provides smart suggestions, and features a
        ...
        <div className="project">
          <a
            href="https://shopease-se-hackethon.streamlit.app"
            target="_blank"
            rel="noreferrer"
          >
            <img
          ...
          <a
            ...
            rel="noreferrer"
          >
            <h2>ShopEase - E-commerce Chatbot</h2>
          </a>
          <p>
            Built an intelligent customer support chatbot using Streamlit and
            Groq AI. Features multi-language support, order tracking, product
            recommendations, voice responses, and real-time AI interactions.{" "}
            <strong>
              Codebase Link{" "}
              <a
                href="https://github.com/Shripad735/ShopEase"
                target="_blank"
                rel="noreferrer"
              >
                here
        ...
        <div className="project">
          <a
            href="https://shripad735.github.io/comp-network/"
            target="_blank"
            rel="noreferrer"
          >
            <img
              {...imageProps}
              src={NetworkVisualizer}
              className="zoom"
              alt="thumbnail"
              width="100%"
            />
          ...
          <p>
            An interactive educational platform for learning computer networking
            concepts. Features line coding visualization, TCP/UDP analysis,
            DNS/HTTP simulations, subnet calculator, and network mapping.{" "}
            <strong>
              Codebase Link{" "}
              <a
                href="https://github.com/Shripad735/comp-network"
                target="_blank"
                rel="noreferrer"
              >
                here
